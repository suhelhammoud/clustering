...
/**
 * <!-- globalinfo-start --> Cluster data using the p means algorithm
 * <p/>
 * <!-- globalinfo-end -->
 *
 ...
 */
public class SimpleKMeans2 extends RandomizableClusterer implements
    ...
    private static String formated(Instance instance) {
        double[] v = new double[instance.numAttributes() - 1];
        for (int i = 0; i <  instance.numAttributes()-1; i++) {
            v[i] = instance.value(i);
        }
        return Point.formated(v).toString();
    }
    /**
    ...
    public void buildClusterer(Instances data) throws Exception {
        ...
        //Added by suhel
        ((EuclideanDistance)m_DistanceFunction).setDontNormalize(true);
        ...
        for (int i = 0; i < m_NumClusters; i++) {
            m_ClusterCentroids.add(initInstances.instance(i));

        }
//        System.out.println(m_ClusterCentroids.toString());
        //suhel remove the random selection
...
//        }
        ...
        while (!converged) {
            ...
            for (i = 0; i < instances.numInstances(); i++) {
                ...
                Pair<Integer, double[]> resultPair = clusterProcessedInstanceD(toCluster, true);
                int newC = resultPair.getKey();//suhel
                double[] newD = resultPair.getValue();//suhel
//                System.out.println(formated(toCluster) + String.format("=> %s , %d", Point.formated(newD), newC) );
...
//            System.out.println(m_ClusterCentroids.toString());
    ...
    private Pair<Integer, double[]> clusterProcessedInstanceD(Instance instance, boolean updateErrors) {
        double[] distances = new double[m_NumClusters];
        ...
        return new Pair<>(bestCluster, distances);
//        return bestCluster;
    }
    /**
